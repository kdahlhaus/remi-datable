class DataTableWithData(gui.Widget):
    ...
    def __init__(self, data_table_options={}, **kwargs):
        ...
        logging.debug("DataTable.__iniit__ kwargs=%s"%kwargs)
        super(DataTableWithData, self).__init__(**kwargs)
        logging.debug("DT style after init %s"%(self.style))
        logging.debug("DT attributes after init %s"%(self.attributes))
    ...
    def repr(self, client, changed_widgets={}):
        #logging.debug("datatable repr self.style:%s"%str(self.style))
        #logging.debug("datatable repr self.attributes:%s"%str(self.attributes))
